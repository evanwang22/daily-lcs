...
!function ($) {
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        $.each(this.options.columns, function (i, column) {
            ...
            if (that.options.sortName === column.field && that.options.sortable && column.sortable) {
                if (column.halign && column.halign == 'right') {
                    text = that.getCaretHtml() + text;
                } else {
    ...
    BootstrapTable.prototype.onSort = function (event) {
        ...
        ($this.data('align') && $this.data('align') == 'right') ? $this.add($this_).data('order', this.options.sortOrder)
            .find('.th-inner').prepend(this.getCaretHtml()) : $this.add($this_).data('order', this.options.sortOrder)
